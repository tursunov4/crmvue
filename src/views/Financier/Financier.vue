<template>
 ...
 import { ref , onMounted } from 'vue';
   ...
   const sidebarGlobal = ref([
     { path: '/financier_income', name: 'Income', child: 'single_product', icon: 'fa-solid fa-coins' },
     { path: '/financier_expence', name: 'Expence', child: 'single_product', icon: 'fa-solid fa-coins' },
 ])
 </script>
